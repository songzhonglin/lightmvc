...
<script type="text/javascript" src="${ctx}/jslib/easyui1.4.2/jquery.parser.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/jslib/easyui1.4.2/datagrid-detailview.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/jslib/easyui1.4.2/locale/easyui-lang-zh_CN.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/jslib/jquery.jqprint-0.3.js" charset="utf-8"></script>


<script charset="utf-8" type="text/javascript" src="http://code.jquery.com/jquery-migrate-1.1.0.js"></script>
...
<script type="text/javascript" src="${ctx}/jslib/CJL.0.1.min.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/jslib/ImageZoom.js" charset="utf-8"></script>

<!-- [扩展lightmvc样式] -->
<!-- <link rel="stylesheet" href="${ctx}/style/css/base.css" type="text/css"> -->
<link rel="stylesheet" href="${ctx}/style/css/lightmvc.css" type="text/css">
<link rel="stylesheet" href="${ctx}/style/css/print.css" type="text/css">